...
<form action="add_achievements_submit.php" METHOD="POST" enctype="multipart/form-data">
    <section class='px-24 mt-25 pt-24 pb-5 flex flex-wrap  justify-around' >
              <div class='w-full text-center my-6  text-white'>
                <h1 class='text-2xl mx-auto leading-relaxed m-1'>ADD YOUR ACHIEVEMENT: </h1>
            </div>
              <div class='m-2 w-1/2'>
                <p class='leading-relaxed'><input name="achievement" class='w-full bg-gray-800 rounded border border-gray-700 text-white focus:outline-none focus:border-teal-500 text-base px-4 py-2' placeholder='' type='text'></p>
              </div>
    </section>

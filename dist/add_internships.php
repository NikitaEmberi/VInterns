...
<header class="fixed top-0 w-full text-gray-500 bg-gray-800 body-font">
    ...
    <form action="add_internship_submit.php" METHOD="POST" enctype="multipart/form-data">
    <section class='text-gray-500 bg-gray-900 body-font overflow-hidden'>
             <div class='container px-20 pt-24 mx-auto'>
                 <div class='flex flex-col'>
                     <h1 class='text-center w-full sm:text-3xl text-2xl font-medium title-font mb-4 pt-6 text-white'>ADD INTERNSHIP</h1>
                 </div>
                 <div>
